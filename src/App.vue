        ...
        <div class="social-icon">
            <div class="container">
                <div class=" row">
                    <div class="col-md-12">
                        <div class="icon">
                            <a href="https://www.linkedin.com/in/igor-lopez-salazar/"><i class="fa fa-linkedin"></i></a>
                            <a href="https://github.com/IgorLopezSalazar"><i class="fa fa-github"></i></a>
                        </div>
...
@media (hover: hover) {
  .links:hover {
    background-color: hsla(182, 80%, 36%, 0.2);
  }
}
